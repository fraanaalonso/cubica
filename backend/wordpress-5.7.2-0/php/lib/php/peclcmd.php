...
if ('/home/fraanaalonso/wordpress-5.7.2-0/php/lib/php ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/home/fraanaalonso/wordpress-5.7.2-0/php/lib/php '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {

...
HTTPD_PIDFILE=/home/fraanaalonso/wordpress-5.7.2-0/apache2/logs/httpd.pid



HTTPD="/home/fraanaalonso/wordpress-5.7.2-0/apache2/bin/httpd -f /home/fraanaalonso/wordpress-5.7.2-0/apache2/conf/httpd.conf"
if [ -f "/home/fraanaalonso/wordpress-5.7.2-0/apps/bitnami/banner/disable-banner" ] ; then
...
. /home/fraanaalonso/wordpress-5.7.2-0/apache2/bin/envvars
